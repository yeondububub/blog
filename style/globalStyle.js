...
const posth1Style = `text-[40px] font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5 break-keep`;
const posth2Style = `text-[32px] font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5 break-keep`;
const posth3Style = `text-[28px] font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5 break-keep`;
const posth4Style = `text-2xl font-bold mb-2 mt-4 break-keep`;
const posth5Style = `text-xl font-bold mb-2 mt-4 break-keep`;
const posth6Style = `text-lg font-bold mb-2 mt-4 break-keep`;

const postpStyle = `text-lg my-6 font-normal tracking-wide text-justify break-keep`;
...
const postulStyle = `list-disc list-inside text-lg font-normal tracking-wide text-justify break-keep`;
const postolStyle = `list-decimal list-inside text-lg font-normal tracking-wide text-justify break-keep`;
const postliStyle = `pl-4 mb-2 leading-relaxed tracking-wide text-justify break-keep`;

const postblockquoteStyle = `border-l-4 border-primary pl-4 break-keep`;
const postpreStyle = `relative bg-graylv1 p-4 rounded-[10px] mb-6 text-base font-medium overflow-x-auto whitespace-pre text-left max-w-full h-auto align-middle`;
...
const posttitleStyle = `md:text-[40px] md:leading-[56px] text-[32px] leading-[40px] font-bold my-3 break-keep`;
...
const notebookpreStyle = `relative bg-graylv1 p-8 rounded-[10px] mb-6 text-base font-medium overflow-x-auto whitespace-pre text-left max-w-full h-auto align-middle`;
...
const bloglistFirstCardDescriptionStyle = `text-graylv4 text-base font-normal leading-snug md:max-h-40 md:line-clamp-[7] line-clamp-3 mb-3 break-keep`;
...
const bloglistCardTitleStyle = `font-bold text-2xl mb-3 break-keep`;
...
const bloglistCardDescriptionStyle = `text-graylv4 text-base font-normal leading-snug h-16 line-clamp-3 mb-3 break-keep`;
